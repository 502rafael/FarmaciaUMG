                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1">
                            <br>
                            <a class="nav-link py-3 px-0 px-lg-2 rounded js-scroll-trigger" href="{{ url('adfarmacia') }}">Productos</a>
...
<br>
        <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <td>{{ $item->cod_detalle }}</td>
                <td>  {{ $item->cod_venta }}</td>
                <td>{{ $item->cod_pro }}</td>
