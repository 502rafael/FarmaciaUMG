...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-left fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="{{ url('inicio') }}">FARMACIA SF</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1">
                            <br>
                            <a class="nav-link py-3 px-0 px-lg-2 rounded js-scroll-trigger" href="#about">Nosotros</a>
                        </li>

                        <li class="nav-item mx-0  mx-lg-1">
                            <br>
                            <a class="nav-link py-3 px-0 px-lg-2 rounded js-scroll-trigger" href="#contact">Ubicacion</a>
                        </li>
                        
                        <li class="nav-item mx-0 mx-lg-1">
                            <br>
                            <a class="nav-link py-3 px-0 px-lg-2 rounded js-scroll-trigger" href="{{ url('productos') }}"> Productos</a>
                        </li>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
                    ...
                    <img class="img-fluid" src="https://cruzverde.com.gt/wp-content/uploads/2019/03/SUKROL.jpg" alt="" />
                </div>
            </div>
            <!-- Portfolio Item 2-->
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
                    ...
                    <img class="img-fluid" src="https://ofertadescuentos.com/wp-content/uploads/2014/09/Farmcia-del-Ahorro-3x2.jpg" alt="" />
                </div>
            </div>
            <!-- Portfolio Item 3-->
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
                    ...
                    <img class="img-fluid" src="https://docplayer.es/docs-images/63/49829709/images/57-4.jpg" alt="" />
                </div>
            </div>
            <!-- Portfolio Item 4-->
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
                    ...
                    <img class="img-fluid" src="https://farmaciasbatres.com.gt/mod/promo/nueva/03-PHARMATON-GERIATRIC-50.jpg" alt="" />
                </div>
            </div>
            <!-- Portfolio Item 5-->
            <div class="col-md-6 col-lg-4 mb-5 mb-md-0">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal5">
                    ...
                    <img class="img-fluid" src="https://farmaciaprovida.com.sv/wp-content/uploads/2020/09/P033902.jpg" alt="" />
                </div>
            </div>
            <!-- Portfolio Item 6-->
            <div class="col-md-6 col-lg-4">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal6">
                    ...
                    <img class="img-fluid" src="https://www.farmaciasleyva.com.mx/Productos_files/FARMACIAS.jpg" alt="" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 ml-auto">
                ...
                <h3>Misión</h3>
                <p class="lead">Somos una empresa cristiana, familiar, guatemalteca con cobertura nacional, enfocada en satisfacer las necesidades de nuestros clientes y en proveer trabajo a nuestros colaboradores por medio de acuerdos de valor agregado.
                </p></div>
            ...
            <div class="col-lg-4 mr-auto">
                ...
                <p class="lead">Ser la primera opción en servicios farmacéuticos integrales como cadena de farmacias para nuestros clientes, con presencia exitosa en otros países de la Región.</p></div>
        </div>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Ubicacion </h2>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <a class="btn btn-outline-light btn-social mx-1" href="https://twitter.com/login?lang=es"><i class="fab fa-fw fa-twitter"></i></a>
